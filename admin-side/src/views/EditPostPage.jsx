...
import { POSTS_ERROR, POSTS_UPDATE } from "../store/actions/actionType";
...
export default function EditPostPage() {
  ...
  const { postDetail, errorMessage, updateStatus } = useSelector(
    (state) => state.post
  );
    ...
    <Container className="w-50" style={{ marginTop: "100px" }}>
      ...
      {modalShow && (
        <ErrorModal
          ...
          title="Warning!"
          content="All Post fields must be filled"
        />
      )}
    </Container>
  );
