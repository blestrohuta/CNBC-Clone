...
import { addPost, fetchCategories } from "../store/actions/actionCreator";
import { POSTS_ADD_RESPONSE, POSTS_ERROR } from "../store/actions/actionType";
...
export default function AddPostPage() {
  ...
  const { postResponse, errorMessage } = useSelector((state) => state.post);
